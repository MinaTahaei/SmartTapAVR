...
_0x0:
	.DB  0x20,0x20,0x20,0x41,0x6C,0x69,0x69,0x69
	.DB  0x0
...
; 0000 0026 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(3)
	OUT  0x1A,R30
; 0000 0027 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=1 Bit0=0
; 0000 0028 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (1<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(2)
	OUT  0x1B,R30
; 0000 0029 
...
; 0000 0046 // Characters/line: 20
; 0000 0047 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 0048 lcd_clear();
	RCALL _lcd_clear
; 0000 0049 lcd_puts("   Aliii");
	__POINTW2MN _0x3,0
	RCALL _lcd_puts
; 0000 004A 
; 0000 004B while (1)
